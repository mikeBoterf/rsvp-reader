...
export function BookCard({ book, progress, isActive, onSelect, onRemove, onProgressTypeChange }: BookCardProps) {
    const progressTypes: LibraryBook['progressDisplayType'][] = ['percent', 'chapter', 'pages'];
    ...
    const progressPercent = book.wordCount > 0
        ? (book.currentWordIndex / book.wordCount) * 100
        : 0;
