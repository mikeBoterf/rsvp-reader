...
def main():
    parser = argparse.ArgumentParser(description="Parse ebook files for RSVP Reader")
    ...
    if args.command == "parse":
        ...
        print(json.dumps({"formats": get_supported_formats()}))

    elif args.command == "version":
        print(json.dumps({"version": "1.0.0", "name": "RSVP Reader Backend"}))
